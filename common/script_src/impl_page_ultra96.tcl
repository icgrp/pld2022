...
namespace eval ::optrace {
  variable script "./prj/prj.runs/impl_1/pfm_top_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  ...
  /home/ylxiao/ws_211/prflow/workspace/F001_overlay/ydma/ultra96/_x/link/int/xo/ip_repo/xilinx_com_hls_ydma_1_0
  ./.local/hw_platform/iprepo
  ...
  update_ip_catalog
  set_property ip_output_repo /home/ylxiao/ws_211/prflow/workspace/F001_overlay/ydma/ultra96/.ipcache [current_project]
...
OPTRACE "add files" END { }
  link_design -part xczu3eg-sbva484-1-i -reconfig_partitions pfm_top_i/dynamic_region
...
OPTRACE "Opt Design: pre hook" START { }
  ...
  if {$src_rc} { 
    ...
    if { $tool_flow eq {SDx} } { 
      send_gid_msg -id 2 -ssname VPL_TCL -severity ERROR $_RESULT
      send_gid_msg -id 3 -ssname VPL_TCL -severity ERROR "./scripts/_full_opt_pre.tcl failed"
    } else {
      send_msg_id runtcl-1 status "$_RESULT"
