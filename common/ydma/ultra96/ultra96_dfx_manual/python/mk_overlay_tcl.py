...
for line in file_in:
  if copy_enable:
    if (line.replace('add_files', '') != line):
      ...
      file_out.write('# ' + line)
      file_out.write('add_files ../../../../../../../ultra96_dfx_manual/checkpoint/hw_bb_divided.dcp\n')
      file_out.write('add_files ../../../../../../../ultra96_dfx_manual/checkpoint/page.dcp\n')
      file_out.write('add_files ../../../../../../../ultra96_dfx_manual/xdc/sub.xdc\n')
      file_out.write('set_property SCOPED_TO_CELLS {pfm_top_i/dynamic_region/ydma_1/page2_inst pfm_top_i/dynamic_region/ydma_1/page3_inst }  [get_files ../../../../../../../ultra96_dfx_manual/checkpoint/page.dcp] \n')
      file_out.write('set_property USED_IN {implementation} [get_files ../../../../../../../ultra96_dfx_manual/xdc/sub.xdc]\n')
      file_out.write('set_property PROCESSING_ORDER LATE [get_files ../../../../../../../ultra96_dfx_manual/xdc/sub.xdc]\n')
    elif (line.replace('reconfig_partitions', '') != line):
      file_out.write('# ' + line)
      file_out.write('link_design -mode default -part xczu3eg-sbva484-1-i -reconfig_partitions {pfm_top_i/dynamic_region/ydma_1/page2_inst pfm_top_i/dynamic_region/ydma_1/page3_inst } -top pfm_top_wrapper\n')
    else:
      file_out.write(line)
