...
for i in range(100):
  ...
  file_out.write('update_design -cell pfm_top_i/dynamic_region/ydma_1/page'+str(i)+'_inst -black_box\n')
  file_out.write('lock_design -level routing\n')
  file_out.write('write_abstract_shell -force -cell pfm_top_i/dynamic_region/ydma_1/page'+str(i)+'_inst p_'+str(i)+'\n')
  file_out.close()
