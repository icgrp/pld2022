...
#include "../operators/rasterization2_odd.h"
#include "../operators/rasterization2_even.h"
...
#pragma HLS STREAM variable=Output_cfb_bot depth=default_depth
  ...
  hls::stream<ap_uint<32> > Output_redir("sb16");
#pragma HLS STREAM variable=Output_redir depth=default_depth
  ...
  TRIANGLES: for (int i = 0; i < NUM_3D_TRI/2; i++)
  {
	...
	data_redir_m(Input_1, Output_redir);
	data_redir_m(Input_1, Output_redir);

	rasterization1(Output_redir, Output_redir_odd, Output_redir_even);
	rasterization1(Output_redir, Output_redir_odd, Output_redir_even);


    rasterization2_odd(Output_redir_odd, Output_r2_odd_top, Output_r2_odd_bot);
    rasterization2_even(Output_redir_even, Output_r2_even_top, Output_r2_even_bot);
